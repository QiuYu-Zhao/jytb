...
public class LogisticsController {
    ...
    public String listPage(@RequestParam String aoData, HttpServletRequest request) {
        ...
        try {
            ...
            totalCount = logisticsService.getLogisticsCountByCondition(condition.toString());
            if(totalCount > 0){
                List<Logistics> logisticsList = logisticsService.getLogisticsListPageByCondition(condition.toString(),page.getCurrentPage(),page.iDisplayLength,"id desc");
